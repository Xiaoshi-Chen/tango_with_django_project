    ...
    def test_gitignore_for_database(self):
        ...
        if git_base_dir.startswith("fatal"):
            ...
            if os.path.exists(gitignore_path):
                self.assertTrue(
                    self.does_gitignore_include_database(gitignore_path),
...
class Chapter5AdminInterfaceTests(TestCase):
    ...
    def test_models_present(self):
        ...
        self.assertTrue(
            "Models in the Rango application" in response_body,
    ...
    def test_page_display_changes(self):
        ...
        self.assertTrue(
            '<div class="text"><a href="?o=1">Title</a></div>' in response_body,
        ...
        self.assertTrue(
            '<div class="text"><a href="?o=2">Category</a></div>' in response_body,
        ...
        self.assertTrue(
            '<div class="text"><a href="?o=3">Url</a></div>' in response_body,
